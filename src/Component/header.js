 ...
 return(
   <React.Fragment>
      <div style={{display:'flex',padding:'5px',justifyContent:'space-between',fontWeight:"",backgroundColor:'brown',height:'60px',width:'auto'}}>
          ...
          <button onClick={console.log("clicked")} style={{display:'flex',margin:'5px',width:'200px',justifyContent:'space-between',border:'0px solid green',borderRadius:'20px',cursor:'pointer',padding:'10px'}}>
